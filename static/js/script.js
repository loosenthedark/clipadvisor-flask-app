$(document).ready(function () {
    ...
    $("#review-submit-form").submit(function () {
        if ($('#review-submit-form-customer-name').val().length >= 4 && $('#review-submit-form-customer-name').val().length <= 50 && $('#review-submit-form-barbershop-name').val().length >= 3 && $('#review-submit-form-barbershop-name').val().length <= 50 && $('#review-submit-form-date-picker').val() != '' && $('#review-submit-form-time-picker').val() != '' && $('#review-submit-form-comments').val().length >= 10 && $('#review-submit-form-comments').val().length <= 1000 && $('.booking-checkbox').filter(':checked').length < 1) {
        ...
        if ($('#review-submit-form-customer-name').val().length >= 4 && $('#review-submit-form-customer-name').val().length <= 50 && $('#review-submit-form-barbershop-name').val().length >= 3 && $('#review-submit-form-barbershop-name').val().length <= 50 && $('#review-submit-form-date-picker').val() != '' && $('#review-submit-form-time-picker').val() != '' && $('#review-submit-form-comments').val().length >= 10 && $('#review-submit-form-comments').val().length <= 1000 && !$('input[name="review-submit-form-star-rating"]').is(':checked')) {
            // customised Flash message
